...
public class HeavyTurretFactory : TurretFactory
{
    /// <summary>
    ...
    public override Turret GetTurret()
    {
        ...
        // Return a heavy turret with the given values
        return new HeavyTurret(_turretModel, _upgradedTurretModel, _level, _damage, _range, _fireRate, _buyCost, _upgradeCost, _sellCost);
    }

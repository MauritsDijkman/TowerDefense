...
class HeavyTurret : Turret
{
    ...
    public HeavyTurret(GameObject turretModel, GameObject upgradedTurretModel, int level, float damage, float range, float fireRate, int buyCost, int upgradeCost, int sellCost)
    {
        _turretModel = turretModel;
        _upgradedTurretModel = upgradedTurretModel;
        _turretType = "HeavyTurret";
        _level = level;
        _damage = damage;
        _range = range;
        _fireRate = fireRate;

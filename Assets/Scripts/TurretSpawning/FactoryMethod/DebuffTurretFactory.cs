...
public class DebuffTurretFactory : TurretFactory
{
    /// <summary>
    ...
    public override Turret GetTurret()
    {
        ...
        // Return a debuff turret with the given values
        return new DebuffTurret(_turretModel, _upgradedTurretModel, _level, _damage, _range, _fireRate, _buyCost, _upgradeCost, _sellCost);
    }
